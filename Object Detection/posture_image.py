...
def process (input_image, params, model_params):
	...
	if all_peaks[16]==[]:
		...
		print("Looking to right from car camera")
	elif all_peaks[16]!=[] and all_peaks[17]!=[] and all_peaks[0]!=[]:
		print("Looking toward car straight")
	elif all_peaks[16] != [] and all_peaks[17] != [] and all_peaks[0] == []:
		print("not facing car straight")
...
if __name__ == '__main__': #main function of the program
	...
	if(vi == False):
	    ...
	    canvas, position= process('./sample_images/4.jpg', params, model_params)
	    showimage(canvas)
	    if (position == 1):
	    	print("Hunchback")
	    elif (position == -1):
