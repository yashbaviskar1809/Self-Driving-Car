...
def process (input_image, params, model_params):
	...
	# 0-> nose \ 14-> left eye \ 15-> right eye \ 16->Left ear \ 17 right ear
	if  all_peaks[0] != [] and (all_peaks[15] != [] or all_peaks[15] == []) and all_peaks[17] == [] and all_peaks[16] != [] and all_peaks[14] != []:
		#print("Looking to right")
		head_position = "RF"
	elif all_peaks[0] != [] and (all_peaks[14] != [] or all_peaks[14] == []) and all_peaks[17] != [] and all_peaks[16] == [] and all_peaks[15] != []:
		#print("Looking to left")
		head_position = "LF"
	elif all_peaks[0] != [] and all_peaks[14] != [] and all_peaks[15] != [] and all_peaks[16] != [] and all_peaks[17] != []:
		#print("Looking toward car stright")
		head_position = "Fwd"
	elif all_peaks[0] == [] and all_peaks[14] == [] and all_peaks[15] == [] and all_peaks[16] != [] and all_peaks[17] != []:
		#print("not facing car stright")
		head_position = "Bwd"
	...
	for i in range(18):
		for j in range(len(all_peaks[i])):
			if i in [0,14,15,16,17] :
				...
				print(" points: ",all_peaks[i][j][0:2]," i: ",i,j)
	return canvas
